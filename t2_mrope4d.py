...
class Yarn(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # ペア並び: 'interleave'（Interleaved-MRoPE互換） or 'block'
    ...
    def apply(self, old_window: int, new_window: int, alpha: int = 1, beta: int = 32):
        ...
        self._cos_index.copy_(theta.cos().to(dtype=self._cos_index.dtype))
        self._sin_index.copy_(theta.sin().to(dtype=self._sin_index.dtype))
        ...
        self._cos_bar.copy_(theta_bar.cos().to(dtype=self._cos_bar.dtype))
        self._sin_bar.copy_(theta_bar.sin().to(dtype=self._sin_bar.dtype))
